...
const CAEmployeeSection = () => {
    ...
    const getEmployee = async () => {
        try {
            ...
            const caDomain = domainResponse?.domains.find(domain => domain.name === "CA");
            ...
            const filterEmployee = response.employees.filter(employee =>
                employee.domains?.some(domain =>
                    domain.id === caDomain.id || caSubdomainIds.includes(domain.id)
                )
            );
...
export default CAEmployeeSection