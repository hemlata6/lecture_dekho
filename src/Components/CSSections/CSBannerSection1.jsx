...
const CSBAnnerSection1 = () => {
    ...
    const getDomainList = async () => {
        try {
            ...
            let filterCA = response?.domains.filter((item) => item?.name === "CS");
        ...
        <div style={{ paddingLeft: isMobile ? '3rem' : '1rem', paddingRight: isMobile ? '3rem' : '1rem', paddingTop: isMobile ? '1rem' : '1', paddingBottom: isMobile ? '1rem' : '2rem', background: '#b7b2b221' }}>
            <Grid container>
                ...
                <Grid item xs={12} sm={4} md={4} lg={4} display={'flex'} justifyContent={'center'} alignItems={'center'}>
                    ...
                    {/* <iframe style={{ width: '100%', height: isMobile ? '100%' : '52vh', border: 'none' }} src='http://192.168.1.34:5175/?instituteid=152' /> */}
                </Grid>
            </Grid>
            <Dialog
...
export default CSBAnnerSection1